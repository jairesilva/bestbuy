...
public class PriceServiceImpl implements PriceService {
	...
	public PriceDTO createPrice(PriceDTO priceDTO) {
		this.validatePriceDTO(priceDTO);
		return null;
	}

	private void validatePriceDTO(PriceDTO priceDTO) {
		checkNotNull(priceDTO, "Category cannot be null.");
		checkNotNull(priceDTO.getAmount(), "Amount cannot be null.");
	}

	// @Override
//	@Transient
//	public ProductDTO createPrice(PriceDTO priceDTO) throws IOException {
